...
def get_face_enhancer() -> Any:
    ...
    with THREAD_LOCK:
        if FACE_ENHANCER is None:
            ...
            FACE_ENHANCER = GFPGANer(model_path=model_path, upscale=2, device=get_device())
...
def pre_check() -> bool:
    ...
    conditional_download(download_directory_path, ['https://github.com/TencentARC/GFPGAN/releases/download/v1.3.5/GFPGANv1.4.pth'])
    return True
