...
# ✔ Import wrinkle enhancer (sesuaikan nama file bila berbeda)
...
def swap_face(source_face: Face, target_face: Face, temp_frame: Frame) -> Frame:
    ...
    # ========================================================
    #   WRINKLE_ENHANCER_V2 — APPLY HERE
    # ========================================================
    try:
        ...
        print(f"[wrinkle enhancer error] {e}")
...
def process_frame(source_face: Face, reference_face: Face, temp_frame: Frame, frame_number: int = 0) -> Frame:
    ...
    return swap_face(source_face, best_face, temp_frame)
